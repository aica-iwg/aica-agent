"""
Django settings for aica_django project.
...
INSTALLED_APPS = [
    ...
    'django_extensions',
    'django_prometheus',
    'aica_django.ma_behaviour_engine',
    'aica_django.ma_collaboration',
    'aica_django.ma_decision_making_engine',
    'aica_django.ma_knowledge_base',
    'aica_django.ma_offline_loader',
    'aica_django.ma_online_learning',
]
